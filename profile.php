    ...
    <footer>
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3><?php echo t('Быстрые ссылки', 'Quick Links', 'Links Rápidos', 'Liens Rapides', 'Schnelllinks'); ?></h3>
                    <ul class="footer-links">
                        <li><a href="index.php?lang=<?php echo $lang; ?>"><i class="fas fa-home"></i> <?php echo $translations['home']; ?></a></li>
                        <li><a href="information.php?lang=<?php echo $lang; ?>"><i class="fas fa-info-circle"></i> <?php echo $translations['information']; ?></a></li>
